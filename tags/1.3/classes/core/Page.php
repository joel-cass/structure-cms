...
require_once getRootPath() . "/classes/helpers/UrlHelper.php";
require_once getRootPath() . "/classes/helpers/FileSystemHelper.php";

require_once getRootPath() . "/classes/core/ContentType.php";
require_once getRootPath() . "/classes/core/Field.php";
require_once getRootPath() . "/classes/core/Layout.php";
require_once getRootPath() . "/classes/core/PageOrder.php";
require_once getRootPath() . "/classes/core/PlaceHolder.php";

require_once getRootPath() . "/classes/includes/lists.php";
